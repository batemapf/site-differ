...
class TestLambdaHandlerIntegration(unittest.TestCase):
    ...
    def test_new_url_triggers_notification(
            self,
            mock_hash,
            mock_normalize,
            mock_fetch,
    ...
    @patch('app.normalize_html')
    @patch('app.compute_hash')
    def test_unchanged_url_no_notification(
            self,
            mock_hash,
            mock_normalize,
            mock_fetch,
    ...
    @patch('app.normalize_html')
    @patch('app.compute_hash')
    def test_changed_url_triggers_notification(
            self,
            mock_hash,
            mock_normalize,
            mock_fetch,
    ...
    @patch('app.normalize_html')
    @patch('app.compute_hash')
    def test_cooldown_blocks_notification_but_updates_state(
            self,
            mock_hash,
            mock_normalize,
            mock_fetch,
        ...
        self.assertNotIn('last_notified_at', update_call)
